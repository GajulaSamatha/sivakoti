...
@section('page_title', 'Update New Event/Pooja')

@section('content')
    <div class="container mt-4">
        <h2>Update New Event or Pooja</h2>
        
        {{-- IMPORTANT: Add enctype for file uploads --}}
        <form method="POST" action="{{ route('superadmin.events_poojas.update', $events_pooja->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $events_pooja->title) }}" required>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="5">{{ old('description', $events_pooja->description) }} </textarea>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="datetime-local" class="form-control" id="start_date" name="start_date" value="{{old('start_date', $events_pooja->start_date) }}" required>
                    @error('start_date') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4 mb-3">
                    <label for="end_date" class="form-label">End Date/Time (Optional)</label>
                    <input type="datetime-local" class="form-control" id="end_date" name="end_date" value="{{old('end_date', $events_pooja->end_date) }}">
                    @error('end_date') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4 mb-3">
                    <label for="location" class="form-label">Location/Venue</label>
                    <input type="text" class="form-control" id="location" name="location" value="{{ old('location', $events_pooja->location) }}" placeholder="e.g., Temple main hall, Online link">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="price" name="price" value="{{ old('price', $events_pooja->price) }}">
